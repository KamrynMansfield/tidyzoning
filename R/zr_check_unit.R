...
#'
#' `zr_check_unit()` takes a tidybuilding and a tidydistrict to see if the district's zoning code allows the tidybuilding based on unit sizes.
#'
...
#' @export
#'
zr_check_unit <- function(tidybuilding, tidydistrict, tidyparcel_dims, building_json, zoning_req = NULL){
  # get the tidydistrict into a list format
  ####### structure_constraints <- fromJSON(tidydistrict$structure_constraints)

  unit_info <- zr_get_unit_info(building_json)
