...
show_shapes <- function(shape1, shape2 = NA, shape3 = NA, shape4 = NA){
  ...
  if (num_na == 3){
    ggplot2::ggplot(shape1) +
      ggplot2::geom_sf(fill = "red",alpha = .5, color = "red4") +
      ggplot2::theme_minimal()
  } else if (num_na == 2){
    ggplot2::ggplot(shape1) +
      ggplot2::geom_sf(fill = "red",alpha = .5, color = "red4") +
      ggplot2::geom_sf(data = shape2, fill = "blue",alpha = .5, color = "blue4") +
      ggplot2::theme_minimal()
  } else if (num_na == 1){
    ggplot2::ggplot(shape1) +
      ggplot2::geom_sf(fill = "red",alpha = .5, color = "red4") +
      ggplot2::geom_sf(data = shape2, fill = "blue",alpha = .5, color = "blue4") +
      ggplot2::geom_sf(data = shape3, fill = "green",alpha = .5, color = "green4") +
      ggplot2::theme_minimal()
  } else if (num_na == 0){
    ggplot2::ggplot(shape1) +
      ggplot2::geom_sf(fill = "red",alpha = .5, color = "red4") +
      ggplot2::geom_sf(data = shape2, fill = "blue",alpha = .5, color = "blue4") +
      ggplot2::geom_sf(data = shape3, fill = "green",alpha = .5, color = "green4") +
      ggplot2::geom_sf(data = shape4, fill = "yellow",alpha = .5, color = "yellow4") +
      ggplot2::theme_minimal()
  }
}
